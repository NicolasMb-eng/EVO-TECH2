...
class ReclamationController extends AbstractController
{
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager,UserRepository $repository,AuthenticationUtils $authenticationUtils): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user = $repository->findOneBy(['email' => $authenticationUtils->getLastUsername()]);
            $reclamation->setTitre($user->getEmail());
     ...
     */
    public function responseRec(MailerInterface $mailer, Request $request, ReclamationRepository $reclamationRepository, UserRepository $userRepository, $id, ResponseReclamationRepository $repository,EntityManagerInterface $entityManager): Response
    {
