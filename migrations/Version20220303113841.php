 ...
 */
final class Version20220303113841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response_reclamation CHANGE content content VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response_reclamation CHANGE content content VARCHAR(255) NOT NULL');
    }
}
